...
class RecentOrdersCardSkeleton extends StatelessWidget {
  const RecentOrdersCardSkeleton({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _skeletonButton(width: double.infinity, height: 50),
                  const SizedBox(width: 12),
                  _skeletonButton(width: double.infinity, height: 50),
                ],
              ),
              const SizedBox(height: 12),
              // Second row of buttons (client and reject)
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
