...
import 'package:goods/services/firestore_services.dart';
...
class _SheetavailableState extends State<Sheetavailable> {
  ...
  // Text controllers are declared here
  ...
  Future<void> _fetchStoreId() async {
    String? fetchedStoreId = await FirestoreService().getStoreId();
    setState(() {
      storeId = fetchedStoreId;
    });
  }

  // Initialize the controllers with initial values coming from widget.product.
