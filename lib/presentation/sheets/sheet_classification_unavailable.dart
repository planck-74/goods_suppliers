...
class SheetClassificationUnavailable extends StatefulWidget {
  const SheetClassificationUnavailable({super.key});

  @override
  _shState createState() => _shState();
}

class _shState extends State<SheetClassificationUnavailable> {
  String? selectedItem; // العنصر المحدد حاليًا

  @override
  Widget build(BuildContext context) {
    var unavailableCubit =
        context.read<UnAvailableCubit>(); // مرجع لـ OfferCubit
          ...
          children: [
            ...
            Wrap(
              ...
              children: manufacturerList.map((item) {
                return _buildSelectableItem(
                    item.toString(), "manufacturer", unavailableCubit);
              }).toList(),
            ),
            ...
            Wrap(
              ...
              children: classificationList.map((item) {
                return _buildSelectableItem(
                    item.toString(), "classification", unavailableCubit);
              }).toList(),
            ),
  ...
  Widget _buildSelectableItem(
      String item, String filterType, UnAvailableCubit unavailableCubit) {
