...
class SheetClassificationOffer extends StatefulWidget {
  ...
  const SheetClassificationOffer({
    super.key,
    this.onClassificationSelected,
    this.currentFilterType,
    this.currentFilterValue,
    this.tabType = 0, // Default to Offer products tab
  });
...
class _SheetClassificationOfferState
    extends State<SheetClassificationOffer> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'تأكد من وجود عروض في هذا القسم',
            style: TextStyle(
              fontSize: 14,
